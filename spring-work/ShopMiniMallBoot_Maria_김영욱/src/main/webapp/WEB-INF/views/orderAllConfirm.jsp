					...
					<tr>
						<td>
							...
							<tbody>
								...
								<tr>
									<td>우편번호</td>
									<td id ="post">${user.post}</td>
								</tr>
								<tr>
									<td>주 소</td>
									<td id ="addr">${user.addr1} ${user.addr2}
									</td>
								</tr>
								<tr>
									<td>휴대전화</td>
									<td id ="phone">${user.phone1}-${user.phone2}-${user.phone3}</td>
								</tr>
								</tbody>
							</table>
						</td>
						...
						<td>
							...
							<tbody>
								...
								<tr>
									<th>휴대전화</th>
									<td>
										<input type="text" id="phone2" name="phone" maxlength="15" value="">
									</td>
								</tr>
								</tbody>
							</table>
