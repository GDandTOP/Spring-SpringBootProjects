	...
	<div class="container">
		<form class="form-horizontal" action="/update" method="post">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" name="no" value="${board.no}" readonly="readonly">
				</div>
				<label for="title" class="col-sm-2 control-label">조회수</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" name="no" value="${board.readcnt}" readonly="readonly">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" name="username" value="${board.username}" readonly="readonly">
				</div>
			</div>
			<div class="form-group">
